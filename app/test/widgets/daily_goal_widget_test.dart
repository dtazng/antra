...
void main() {
  ...
  group('DailyGoalWidget', () {
    testWidgets('0/3: shows 0 / 3 completed and progress bar', (tester) async {
      await tester.pumpWidget(wrap(
        const DailyGoalWidget(goal: DailyGoal(reached: 0)),
      ));
      expect(find.textContaining('0 / 3'), findsOneWidget);
      // Progress bar is a custom gradient FractionallySizedBox, not LinearProgressIndicator.
    ...
    testWidgets('2/3: progress bar widthFactor equals 2/3', (tester) async {
      await tester.pumpWidget(wrap(
      ...
      expect(box.widthFactor, closeTo(2 / 3, 0.001));
    });
